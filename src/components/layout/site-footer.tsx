...
export async function SiteFooter() {
  ...
  const links = [[dictionary.nav.services,"/services"],[dictionary.nav.portfolio,"/portfolio"],[dictionary.nav.process,"/cara-kerja"],[dictionary.nav.about,"/about"],[dictionary.nav.startProject,loginUrl("/start-project")]] as const;
