...
export function WorkflowArtifacts({ isId }: { isId: boolean }) {
  const copy = isId
    ? {
        demo: "Demonstrasi",
        caption: "Contoh scope board RRS · tanpa data Client nyata",
        workspace: "Scope board",
        project: "Kebutuhan proyek terstruktur",
        attention: "Siap ditinjau",
        quotation: "Scope & quotation",
        agreement: "Deliverables disusun",
        invoice: "Timeline & terms",
        progress: "Kejelasan scope",
        activeStage: "Konteks awal",
        nextReview: "Berikutnya · review scope",
        scope: "Dari kebutuhan ke keputusan",
        milestones: "Deliverables",
        messages: "Prioritas",
        files: "Referensi",
        quoteLabel: "RRS / Scope board",
        quoteTitle: "Scope sebelum commitment",
        included: ["Kebutuhan awal", "Deliverables", "Timeline & payment terms"],
        statusLabel: "RRS / Proses",
        statusTitle: "Dari brief hingga delivery",
      }
    : {
        demo: "Demonstration",
        caption: "RRS scope board example · no real Client data",
        workspace: "Scope board",
        project: "Structured project needs",
        attention: "Ready to review",
        quotation: "Scope & quotation",
        agreement: "Deliverables outlined",
        invoice: "Timeline & terms",
        progress: "Scope clarity",
        activeStage: "Initial context",
        nextReview: "Up next · scope review",
        scope: "From need to decision",
        milestones: "Deliverables",
        messages: "Priorities",
        files: "References",
        quoteLabel: "RRS / Scope board",
        quoteTitle: "Scope before commitment",
        included: ["Initial need", "Deliverables", "Timeline & payment terms"],
        statusLabel: "RRS / Process",
        statusTitle: "From brief through delivery",
      };
