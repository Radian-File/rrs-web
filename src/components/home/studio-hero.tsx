  ...
  return (
    <section data-hero-motion className="rrs-grain relative isolate min-h-[calc(100svh-72px)] overflow-hidden border-b border-border bg-[#101211] text-foreground" aria-labelledby="home-hero-title">
      ...
      <div className="relative mx-auto flex max-w-[1440px] flex-col items-center px-5 pb-0 pt-14 text-center md:px-8 lg:px-12 lg:pt-16 xl:px-16">
        <div data-hero-copy className="relative z-30 flex max-w-6xl flex-col items-center">
          ...
          <h1 id="home-hero-title" className="mt-6 font-display text-[clamp(3.2rem,7.4vw,7.5rem)] font-black uppercase leading-[.82] tracking-[-.075em] text-[#f5f2ea]">
            {copy.titleLines.map((line) => (
              <span key={line} className="block overflow-hidden px-[.06em] pb-[.1em] [perspective:900px]">
          ...
          <div data-hero-actions className="mt-7 flex flex-col items-center gap-3 sm:flex-row">
            ...
            <Button asChild size="lg" variant="ghost" className="text-white/72 hover:bg-white/[.06] hover:text-white"><Link href="/cara-kerja">{copy.secondary}<ArrowRight className="size-4" aria-hidden="true" /></Link></Button>
          </div>
