...
export function Brand({ className }: { className?: string }) {
  return (
    <Link href="/" className={cn("inline-flex items-center gap-3", className)} aria-label="RRS Freelancer home">
      <span className="grid size-9 overflow-hidden rounded-[10px] bg-black">
        <Image src="/rrs-mark.png" alt="" width={36} height={36} priority className="size-full object-cover object-center" />
      </span>
