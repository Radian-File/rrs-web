...
export function ContactComposition({
  ...
  const copy = isId
    ? {
        ...
        title: "Ceritakan konteks proyek Anda. Kita tentukan langkah awalnya.",
        description:
          "Gunakan form untuk pertanyaan awal atau WhatsApp untuk percakapan langsung. Saat kebutuhan siap dibahas lebih detail, Anda dapat melanjutkan ke brief proyek dan quotation.",
        guest: "Diskusi awal",
        guestTitle: "Mulai tanpa komitmen",
        guestDescription: "Form dan WhatsApp membuka percakapan awal. Keduanya tidak otomatis membuat proyek, quotation, atau invoice.",
        whatsapp: "Diskusi melalui WhatsApp",
        formal: "Brief proyek",
        formalTitle: "Simpan detail proyek dalam satu alur",
        formalDescription: "Akun menghubungkan brief, quotation, agreement, proyek, dan dokumen privat ke identitas Anda.",
        formEyebrow: "Pertanyaan awal",
        formTitle: "Kirim konteks yang ingin dibahas.",
        formDescription: "Kami menggunakan pesan ini untuk memahami kebutuhan awal. Ruang lingkup, timeline, dan harga final ditentukan melalui quotation.",
        received: "Pesan Anda sudah diterima.",
        receivedDescription: "Lanjutkan ke WhatsApp bila Anda ingin membahasnya lebih cepat. Nomor referensi pesan sudah disertakan.",
    ...
    : {
        eyebrow: "Contact / Guest discussion",
        title: "Share your project context. We will identify the right first step.",
        description:
          "Use the form for an initial question or WhatsApp for a direct conversation. Once the need is ready to discuss in detail, you can continue to a project brief and quotation.",
        guest: "Initial discussion",
        guestTitle: "Begin without commitment",
        guestDescription: "The form and WhatsApp open an initial conversation. Neither automatically creates a project, quotation, or invoice.",
        whatsapp: "Discuss through WhatsApp",
        formal: "Project brief",
        formalTitle: "Keep project details in one flow",
        formalDescription: "An account connects your brief, quotation, agreement, project, and protected documents to your identity.",
        formEyebrow: "Initial question",
        formTitle: "Send the context you would like to discuss.",
        formDescription: "We use this message to understand the initial need. The final scope, timeline, and price are defined through a quotation.",
        received: "Your message has been received.",
        receivedDescription: "Continue on WhatsApp if you would like to discuss it sooner. The message reference is included.",
