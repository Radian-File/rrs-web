          ...
          <div className="mx-auto grid max-w-[1280px] gap-16 px-5 py-20 md:px-8 lg:grid-cols-[1.02fr_.98fr] lg:px-16 lg:py-28">
            <div className="flex flex-col justify-center">
              ...
              <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-xs text-secondary">
                <span>{dictionary.home.popular}</span><Link href="/services?type=web-development" className="hover:text-primary">Website Development</Link><Link href="/services?type=design" className="hover:text-primary">UI/UX Design</Link><Link href="/services?type=web-application" className="hover:text-primary">Web Application</Link>
              </div>
            </div>
