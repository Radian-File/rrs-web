...
export default async function OwnerServicesPage({ searchParams }: { searchParams: Promise<{ page?: string; q?: string; type?: string; drafts?: string }> }) {
  const { page: rawPage, q: rawQuery, type: rawType, drafts } = await searchParams;
